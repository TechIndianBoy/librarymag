    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                [
                    'class' => 'yii\rest\UrlRule',
                    'controller' => 'v1/libmag',
                    'pluralize' => false,
                    'tokens' => [
                    ],
                    'extraPatterns' => [
                        'OPTIONS {id}' => 'options',
                        'POST loginmethod' => 'loginmethod',
                        'OPTIONS loginmethod' =>'options',
                        'GET seebook' => 'seebook',
                        'OPTIONS seebook' =>'options',
                        'POST enteruser' => 'enteruser',
                        'OPTIONS enteruser' =>'options',                        
                        'GET seealluser' => 'seealluser',
                        'OPTIONS seealluser' =>'options',
                        'POST enternewbook' => 'enternewbook',
                        'OPTIONS enternewbook' =>'options',
                        'POST updatepassword' => 'updatepassword',
                        'OPTIONS updatepassword' =>'options',
                        'POST maketransaction' => 'maketransaction',
                        'OPTIONS maketransaction' =>'options',
                        'POST returnbook' => 'returnbook',
                        'OPTIONS returnbook' =>'options',
                        'POST deleteuser' => 'deleteuser',
                        'OPTIONS deleteuser' =>'options',
                        'POST increasebookcount' => 'increasebookcount',
                        'OPTIONS increasebookcount' =>'options',
                    ]
                ],
            ]
        ],
